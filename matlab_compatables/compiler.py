...
def mwptp(raw, epochs, ecodes, tmin, tmax, baseline, channel, step, win, thresh):   # one channel only so far; need another for loop to iterate over multiple channels
    '''ecodes must be a list of strings'''
